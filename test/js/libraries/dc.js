...
dc.geoChoroplethChart = function (parent, chartGroup) {
    ...
    _chart._doRender = function () {
	    ...
	    console.log("index " + layerIndex + "; name " +  geoJson(layerIndex).name);
    ...
    function generateLayeredData() {
	    ...
	    if (_chart.keyAccessor()(groupAll[i]) != "00000") {
   	       console.log("key is " + _chart.keyAccessor()(groupAll[i]) + "; data is "+_chart.valueAccessor()(groupAll[i]));
